...
int findMaxCalories(std::vector<int> elvesCalories)
{
    ...
    for (auto calories : elvesCalories)
    {
        ...
        else if (calories > secondMaxCalories) secondMaxCalories = calories;
        else if (calories > thirdMaxCalories) thirdMaxCalories = calories;
    }
...
int main()
{
    ...
    std::cout << "Total of top 3 calories: " << highestCalories << std::endl;
